...
from utils import load_data_from_npy, y_single_to_list, get_confusion_matrix
...
# # y_new = [change(y) for y in y_test]
...
# # test_result = model1.evaluate(x_test, y_test)
# #
#
# # print(get_confusion_matrix(y_actual=y_test, y_predicted=predictions1))