import sys
import argparse
from yolo import YOLO, detect_video,detect_camera
...
def detect_imgdir(yolo, dir, output_txt=False):
    ...
    for img in img_files:
        try:
            ...
            detections = list()
            r_image = yolo.detect_image_evaluate(image, single_image=False, output=detections)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help='camera mode, will ignore all positional arguments'
    )
    '''
